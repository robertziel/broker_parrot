...
These pin the GB10-specific signal logic WITHOUT shelling out to nvidia-smi:
...
# A real GB10 sample (spark2): the render PID busy at sm=95, the idle gnome/Xorg
...
# Our container's process present but idle (sm = "-"): the common GB10 hang
